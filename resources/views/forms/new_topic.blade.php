...
{{ Form::open(array('id'=>'new_topic_form', 'data-abide'=>'ajax', 'url'=>'topic/new','method'=>'POST', 'files'=>true)) }}
   ...
   @endif
    ...
    <div class="row"><div class="columns">
        <label>Title:
            <input type="text" required id="title" name="title" @if(isset($edit)) value="{{$topic->title}}" @endif/>
        </label>
    ...
    <div class="row"><div class="columns">
        ...
        @if(isset($edit))
            @include('forms.elements.texteditor', ['id' => 'description', 'required' => 'required', 'error_msg' => 'Please enter a description for the topic.', 'content' => $topic->description])
        @else
    ...
    <div class="row"><div class="columns">
        <label>Goal:</label>
        @if(isset($edit))
            @include('forms.elements.texteditor', ['id' => 'goal', 'required' => 'required', 'error_msg' => 'Please enter a goal for the topic.', 'content' => $topic->goal])
        @else
    ...
    <fieldset class="form-inline">
       <h3>Topic duration</h3>
        ...
        <div class="row"><div class="columns large-6">
            ...
            <div class="field">
                <input type="date" id="start_date" pattern="day_month_year" placeholder="dd/mm/yyyy" @if(isset($edit)) value="{{ date_format(new DateTime($topic->start_date), 'd/m/Y')}}" @endif data-date-format="dd/mm/yyyy" name="start_date" required />
        ...
        <div class="row"><div class="columns large-6">
            ...
            <div class="field">
                <input type="date" id="end_date" pattern="day_month_year" placeholder="dd/mm/yyyy" @if(isset($edit)) value="{{ date_format(new DateTime($topic->end_date), 'd/m/Y')}}" @endif data-date-format="dd/mm/yyyy" name="end_date" required />
